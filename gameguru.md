...
## 🎯 Acciones de semana en My Picks — BUILD-UX (2026-08-12)

Reubicación UX de `📥 Exportar auditoría` y `👁️ Ver Picks Públicos` en My Picks: se movieron del final de la lista de partidos a **justo debajo de los tabs de semana y el estado/deadline, antes de la grilla** (visibles sin hacer scroll, incluso en semanas de 16 juegos).
